<template>
  <div>
    ...
    <div style="padding-top: 10px">
      ...
      <el-button type="danger" @click="delBatch" style="margin-left: 10px;font-size: 18px;"><i class="el-icon-a-022" style="padding-right: 6px;font-size: 22px;"></i>批量删除</el-button>
    </div>
    <!--          表格-->
