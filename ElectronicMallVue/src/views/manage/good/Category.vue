  ...
  <div>
    ...
    <el-dialog title="修改上级分类" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editIcon" style="font-size: 20px;"><i class="iconfont icon-r-yes" style="font-size: 22px;"></i>确定</el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog title="新增上级分类" :visible.sync="addDialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="addDialogFormVisible = false" style="font-size: 20px;"><i class="iconfont icon-r-left" style="font-size: 22px;"></i>取消</el-button>
        <el-button type="primary" @click="saveIcon" style="font-size: 20px;"><i class="iconfont icon-r-yes" style="font-size: 22px;"></i>确定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
