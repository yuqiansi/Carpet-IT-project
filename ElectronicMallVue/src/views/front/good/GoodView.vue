            ...
            <div class="detail-box">
                ...
                <div style="margin-top: 30px">
                    <el-button type="success" @click="goToOrder"
                        ...
                        >
                        <i class="iconfont icon-r-yes" style="font-size: 22px;"></i>购买</el-button
                    >
                    <el-button
                        type="primary"
                        @click="addToCart"
                        style="font-size: 20px;"
                        >
                        <i class="iconfont icon-r-add" style="font-size: 22px;"></i>加入购物车</el-button
                    >
                </div>
            </div>
        </div>
    ...
    methods: {
        getPriceRange(standards) {
            ...
            if (arr[0] === arr[arr.length - 1]) {
                ...
                return arr[0] + "AUD! " + arr[arr.length - 1];
            }
        },
        change(standard) {
            this.showStore = true;
    ...
    computed: {
        ...
        realPrice: function () {
            if (this.good.discount < 1) {
                ...
                if (isNaN(this.price)) {
                    let down =
                        this.price.substring(0, this.price.indexOf("AUD")) *
                        this.good.discount;
                    let up =
                        this.price.substring(this.price.lastIndexOf(" ")) *
                        this.good.discount;
                    return down.toFixed(2) + "AUD!  " + up.toFixed(2);
                } else {
