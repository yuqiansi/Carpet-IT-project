    ...
    <el-row>
      <el-col :span="3">
        <div style="font-size: 20px; font-weight: bold; text-align: center">
          <a href="/"><i class="el-icon-a-011"></i>CarpetIT Shopping Mall</a>
        </div>
      </el-col>
      <el-col :span="17">
        <el-menu
          ...
          router
        >
          <el-menu-item index="/" class="menu-item">CarpetIT</el-menu-item>
          ...
          <el-menu-item index="/orderlist" class="menu-item"
            >My Order</el-menu-item
          >
          <el-menu-item
            index="/manage"
            class="menu-item"
            v-if="role === 'admin'"
            >Backend Management</el-menu-item
          >
        </el-menu>
      </el-col>
      <el-col :span="4">
        ...
        <el-dropdown style="cursor: pointer; float: right; margin-right: 60px">
          ...
          <el-dropdown-menu slot="dropdown" style="text-align: center">
            ...
            <el-dropdown-item v-show="loginStatus">
              <div @click="$router.push('/person')">Personal Information</div>
            </el-dropdown-item>
            <el-dropdown-item v-show="loginStatus">
